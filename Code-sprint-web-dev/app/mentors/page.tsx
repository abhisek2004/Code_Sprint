...
const mentors: Mentor[] = [
  {
    ...
    bio: 'MSIT CSE’26 | SDE Intern @ Veersa | Ex Python Intern @Infosys Springboard | Rank #24 @GSSoC’24 | Ex Intern @ SSPL DRDO | Tech Lead @ Prakriti MSIT',
    expertise: ['JavaScript', 'React', 'Node.js', 'MongoDB', 'Web3'],
    github: 'https://github.com/meetarora10',
    linkedin: 'https://www.linkedin.com/in/meet-arora-603682296/',
    featured: true,
  },
  {
    name: 'Mudit Khater',
  ...
  },
  {
    ...
    role: 'Frontend Architect & Designer',
    bio: 'CSE’29 @ IIIT Agartala | Aspiring SDE | Java | Data Structures & Algorithms | Exploring Full-Stack Development.',
    expertise: ['React', 'TypeScript', 'Tailwind CSS', 'Next.js', 'Web Performance'],
    github: 'https://github.com/parthibanaskar',
    linkedin: 'https://www.linkedin.com/in/parthibanaskar/',
    featured: true,
  },
]
